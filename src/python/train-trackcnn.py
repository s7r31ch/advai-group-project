...
from nn.network.TrackCNN import TrackCNN
...
if __name__ == "__main__":
    ...
    BATCH_SIZE = 32
    NUM_EPOCHS = 10
    MODEL_SAV_PATH = "src/resources/trackcnn-20250326.pth"
    LOG_FILE_PATH = "src/resources/train-log-trackcnn.log"
    
    logger = Log4P(enable_level = True,
                   enable_timestamp = True,
                   enable_source = True,
                   enable_log_file = True,
                   source = "train-trackcnn",
    ...
    model = TrackCNN(num_labels = 6).to(device)
